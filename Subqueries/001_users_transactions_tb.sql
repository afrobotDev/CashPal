...
VALUES
  ('Hunter', 30, 'US', 'Hdev92', 'backendDev', false);
...
VALUES
  (1, 4, 'Testing transaction!', 10.50, true);
...
VALUES
  (1, 10, 'Thanks for lunch!', 9.56, true);
...
INSERT INTO
  transactions (user_id, sender_id, note, amount, was_successful)
VALUES
  (1, 18, 'thanks for lunch yesterday', 10.00, true);
...
VALUES
  (1, 16, 'Concert ticket split', 72.40, true);

INSERT INTO
  transactions (user_id, sender_id, note, amount, was_successful)
VALUES
  (1, 17, 'Repaying train fare', 18.75, true);
...
VALUES
  (14, 1, 'Weekend groceries share', 34.12, true);

INSERT INTO
  transactions (user_id, sender_id, note, amount, was_successful)
VALUES
  (18, 19, 'Board game night snacks', 27.50, false);
...
VALUES
  (17, 16, 'Airport pickup gas money', 15.00, true);

INSERT INTO
  transactions (user_id, sender_id, note, amount, was_successful)
VALUES
  (10, 15, 'Shared office lunch order', 42.30, true);
